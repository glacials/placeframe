...
struct ProcessingViewModel {
    ...
    var assurance: String {
        "This is the real processing pipeline. Nothing is written to Photos on this screen, and review opens as soon as this finishes."
    }
...
enum ProcessingProgressPhase: String, CaseIterable {
    ...
    var subtitle: String {
        ...
        case .reverseGeocodingPlaces:
            "Turning proposed coordinates into human-readable place labels so the review screen feels grounded."
        case .preparingReview:
